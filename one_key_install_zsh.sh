...
main() {
  ...
  wget https://raw.githubusercontent.com/yw9381/oh-my-zsh_theme_line/master/zshrc -O ~/.zshrc
  wget https://raw.githubusercontent.com/yw9381/oh-my-zsh_theme_line/master/dircolors -O ~/.dircolors
