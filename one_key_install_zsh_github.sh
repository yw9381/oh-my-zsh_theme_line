...
download_theme(){
  ...
  wget https://raw.githubusercontent.com/yw9381/oh-my-zsh_theme_line/master/zshrc -O ~/.zshrc > /dev/null
  wget https://raw.githubusercontent.com/yw9381/oh-my-zsh_theme_line/master/dircolors -O ~/.dircolors > /dev/null
}
